...
var createSeed = function (options, cb) {
	...
	let fn = function (callback) {
		...
		options.outputPath = (typeof options.outputPath === 'string' && options.outputPath.length) ? options.outputPath : path.join(__dirname, '../../../content/files/dbseed/seed_data.json');
