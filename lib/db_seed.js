...
var handleSeriesInsertQueue = function (data, queue, order) {
	...
	return Promisie.map(data, 1, datatype => {
		return handleParallelInsertQueue(datatype, queue);
	})
...
var importSeed = function (options, cb) {
	options = Object.assign({}, importOptions, options);
...
var initialize = function (resources) {
	...
	try {
		...
		importOptions = import_configuration.importoptions || {};
	}
	catch (e) {
